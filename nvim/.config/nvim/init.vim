...
" Read tags generated by our `git-ctags` script.
set tags+=.git/tags

" Keep tags fresh.
autocmd vimrc BufWritePost * call tags#update()
...
" Directories for additional snippets.
let s:snippets = [
      \ s:config . '/snippets/',
      \ s:plugged . '/vim-snippets/snippets/',
      \ ]

let g:neosnippet#snippets_directory = join(s:snippets, ',')
